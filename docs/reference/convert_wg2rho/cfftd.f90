...
subroutine dpssb3 (ido,l1,cc,ch,wa1,wa2)
    double precision cc(ido,3,l1), ch(ido,l1,3), wa1(*), wa2(*), ci2, ci3, cr2, cr3, di2, di3, dr2, dr3, taui, taur, ti2, tr2
    data taur / -0.5d0 /
...
subroutine dpssb4 (ido,l1,cc,ch,wa1,wa2,wa3)
    double precision cc(ido,4,l1), ch(ido,l1,4), wa1(*), wa2(*),wa3(*), ci2, ci3, ci4, cr2, cr3, cr4, ti1, ti2, ti3, ti4, tr1, tr2, tr3, tr4
    if (ido .ne. 2) then
        do  k=1,l1
            do i=2,ido,2
...
subroutine dpssb5 (ido,l1,cc,ch,wa1,wa2,wa3,wa4)
    double precision cc(ido,5,l1), ch(ido,l1,5), wa1(*), wa2(*), wa3(*), wa4(*), ci2, ci3, ci4, ci5, cr2, cr3, cr4, cr5, di2, di3, di4, di5, dr2, dr3, dr4, dr5, ti11, ti12, ti2, ti3, ti4, ti5, tr11, tr12, tr2, tr3, tr4, tr5
...
subroutine dpssb (nac,ido,ip,l1,idl1,cc,c1,c2,ch,ch2,wa)
    double precision cc(ido,ip,l1), c1(ido,l1,ip), c2(idl1,ip), ch(ido,l1,ip), ch2(idl1,ip), wa(*), wai, war
    idot = ido/2
    nt = ip*idl1
    ipp2 = ip+2
    ipph = (ip+1)/2
